...
C {devices/lab_wire.sym} 1810 -1320 0 1 {name=p7 sig_type=std_logic lab=VOUT
}
...
current=2.9544e-06}
C {devices/lab_wire.sym} 1070 -770 2 0 {name=p9 sig_type=std_logic lab=vgs5}
...
current=2.9544e-06}
C {devices/iopin.sym} 1150 -630 0 0 {name=p2 lab=VDD}
